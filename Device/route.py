...
device_routes.route('/peak', methods=['POST'])(controller.peak_consumption_between_times)

device_routes.route("/sum")(controller.sum_consumption_between_times)

device_routes.route("/duplicate")(controller.duplicate_consumption_between_times)
